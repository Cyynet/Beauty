...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        for (NSInteger index = 0; index < separateLabelCount; index ++) {
            ...
            separateLabel.text = @":";
            separateLabel.textColor = TEXTCOLOR;
...
- (UILabel *)minuesLabel{
    if (_minuesLabel == nil) {
        ...
        _minuesLabel.textColor = TEXTCOLOR;
        _minuesLabel.font = TEXTFONT;
    }
    return _minuesLabel;
}
...
- (UILabel *)secondsLabel{
    if (_secondsLabel == nil) {
        ...
        _secondsLabel.textColor = TEXTCOLOR;
        _secondsLabel.font = TEXTFONT;
    }
